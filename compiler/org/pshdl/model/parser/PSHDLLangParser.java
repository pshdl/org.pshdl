...
public class PSHDLLangParser extends Parser {
	...
	public static final int
		...
		T__4=39, T__3=40, T__2=41, T__1=42, T__0=43, AND=44, OR=45, XOR=46, LOGI_AND=47, 
		LOGI_OR=48, MUL=49, DIV=50, PLUS=51, MOD=52, POW=53, SLL=54, SRA=55, SRL=56, 
		EQ=57, NOT_EQ=58, LESS=59, LESS_EQ=60, GREATER=61, GREATER_EQ=62, ASSGN=63, 
		ADD_ASSGN=64, SUB_ASSGN=65, MUL_ASSGN=66, DIV_ASSGN=67, MOD_ASSGN=68, 
		AND_ASSGN=69, XOR_ASSGN=70, OR_ASSGN=71, SLL_ASSGN=72, SRL_ASSGN=73, SRA_ASSGN=74, 
		ARITH_NEG=75, BIT_NEG=76, LOGIC_NEG=77, ANY_INT=78, ANY_UINT=79, ANY_BIT=80, 
		ANY_IF=81, ANY_ENUM=82, BIT=83, INT=84, UINT=85, STRING=86, BOOL=87, ENUM=88, 
		INTERFACE=89, FUNCTION=90, MODULE=91, TESTBENCH=92, RULE_PS_LITERAL_TERMINAL=93, 
		RULE_ID=94, RULE_STRING=95, RULE_ML_COMMENT=96, RULE_GENERATOR_CONTENT=97, 
		RULE_SL_COMMENT=98, RULE_WS=99;
	public static final String[] tokenNames = {
		"<INVALID>", "'default'", "'.*'", "'{'", "'for'", "'include'", "'('", 
		"'package'", "','", "'const'", "']'", "'@'", "'#'", "'simulation'", "'register'", 
		"'generate'", "'native'", "'process'", "'record'", "'inline'", "';'", 
		"'extends'", "'}'", "'if'", "'?'", "'$rst'", "'inout'", "'switch'", "'.'", 
		"'param'", "'case'", "'->'", "'out'", "'substitute'", "'$clk'", "':'", 
		"'['", "'=>'", "'in'", "'else'", "')'", "'+:'", "'-:'", "'import'", "'&'", 
		"'|'", "'^'", "'&&'", "'||'", "'*'", "'/'", "'+'", "'%'", "'**'", "'<<'", 
		"'>>'", "'>>>'", "'=='", "'!='", "'<'", "'<='", "'>'", "'>='", "'='", 
		"'+='", "'-='", "'*='", "'/='", "'%='", "'&='", "'^='", "'|='", "'<<='", 
		"'>>>='", "'>>='", "'-'", "'~'", "'!'", "'int<>'", "'uint<>'", "'bit<>'", 
		"'interface<>'", "'enum<>'", "'bit'", "'int'", "'uint'", "'string'", "'bool'", 
		"'enum'", "'interface'", "'function'", "'module'", "'testbench'", "RULE_PS_LITERAL_TERMINAL", 
		"RULE_ID", "RULE_STRING", "RULE_ML_COMMENT", "RULE_GENERATOR_CONTENT", 
		"RULE_SL_COMMENT", "RULE_WS"
	};
	public static final int
		RULE_psModel = 0, RULE_psUnit = 1, RULE_psExtends = 2, RULE_psImports = 3, 
		RULE_psQualifiedNameImport = 4, RULE_psBlock = 5, RULE_psProcess = 6, 
		RULE_psInstantiation = 7, RULE_psInterfaceInstantiation = 8, RULE_psDirectGeneration = 9, 
		RULE_psPassedArguments = 10, RULE_psArgument = 11, RULE_psCast = 12, RULE_psExpression = 13, 
		RULE_psValue = 14, RULE_psBitAccess = 15, RULE_psAccessRange = 16, RULE_psVariableRef = 17, 
		RULE_psRefPart = 18, RULE_psVariable = 19, RULE_psStatement = 20, RULE_psFunctionDeclaration = 21, 
		RULE_psInlineFunction = 22, RULE_psSubstituteFunction = 23, RULE_psNativeFunction = 24, 
		RULE_psFuncRecturnType = 25, RULE_psFuncParam = 26, RULE_psFuncSpec = 27, 
		RULE_psFuncParamWithRW = 28, RULE_psFuncOptArray = 29, RULE_psFuncParamRWType = 30, 
		RULE_psFuncParamType = 31, RULE_psFunction = 32, RULE_psFuncArgs = 33, 
		RULE_psAssignmentOrFunc = 34, RULE_psAssignmentOp = 35, RULE_psCompoundStatement = 36, 
		RULE_psIfStatement = 37, RULE_psSimpleBlock = 38, RULE_psForStatement = 39, 
		RULE_psSwitchStatement = 40, RULE_psCaseStatements = 41, RULE_psDeclaration = 42, 
		RULE_psDeclarationType = 43, RULE_psTypeDeclaration = 44, RULE_psEnumDeclaration = 45, 
		RULE_psEnum = 46, RULE_psVariableDeclaration = 47, RULE_psDeclAssignment = 48, 
		RULE_psArrayInit = 49, RULE_psArrayInitSubParens = 50, RULE_psArrayInitSub = 51, 
		RULE_psArray = 52, RULE_psDirection = 53, RULE_psAnnotation = 54, RULE_psAnnotationType = 55, 
		RULE_psPrimitive = 56, RULE_psPrimitiveType = 57, RULE_psWidth = 58, RULE_psInterfaceDeclaration = 59, 
		RULE_psInterface = 60, RULE_psInterfaceExtends = 61, RULE_psInterfaceDecl = 62, 
		RULE_psPortDeclaration = 63, RULE_psQualifiedName = 64;
	public static final String[] ruleNames = {
		"psModel", "psUnit", "psExtends", "psImports", "psQualifiedNameImport", 
		...
		"psFuncSpec", "psFuncParamWithRW", "psFuncOptArray", "psFuncParamRWType", 
		"psFuncParamType", "psFunction", "psFuncArgs", "psAssignmentOrFunc", "psAssignmentOp", 
		"psCompoundStatement", "psIfStatement", "psSimpleBlock", "psForStatement", 
		"psSwitchStatement", "psCaseStatements", "psDeclaration", "psDeclarationType", 
		"psTypeDeclaration", "psEnumDeclaration", "psEnum", "psVariableDeclaration", 
		"psDeclAssignment", "psArrayInit", "psArrayInitSubParens", "psArrayInitSub", 
		"psArray", "psDirection", "psAnnotation", "psAnnotationType", "psPrimitive", 
		"psPrimitiveType", "psWidth", "psInterfaceDeclaration", "psInterface", 
	...
	public final PsModelContext psModel() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 9) | (1L << 11) | (1L << 13) | (1L << 14) | (1L << 16) | (1L << 18) | (1L << 19) | (1L << 26) | (1L << 29) | (1L << 32) | (1L << 33) | (1L << 38))) != 0) || ((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & ((1L << (BIT - 83)) | (1L << (INT - 83)) | (1L << (UINT - 83)) | (1L << (STRING - 83)) | (1L << (BOOL - 83)) | (1L << (ENUM - 83)) | (1L << (INTERFACE - 83)) | (1L << (MODULE - 83)) | (1L << (TESTBENCH - 83)))) != 0)) {
				{
				setState(138);
	...
	public final PsUnitContext psUnit() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				consume();
				setState(150); psInterface();
				setState(152);
				_la = _input.LA(1);
				if (_la==21) {
					{
					setState(151); psExtends();
					}
				}
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 3) | (1L << 4) | (1L << 5) | (1L << 9) | (1L << 11) | (1L << 13) | (1L << 14) | (1L << 16) | (1L << 17) | (1L << 18) | (1L << 19) | (1L << 23) | (1L << 25) | (1L << 26) | (1L << 27) | (1L << 29) | (1L << 32) | (1L << 33) | (1L << 34) | (1L << 38))) != 0) || ((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & ((1L << (BIT - 83)) | (1L << (INT - 83)) | (1L << (UINT - 83)) | (1L << (STRING - 83)) | (1L << (BOOL - 83)) | (1L << (ENUM - 83)) | (1L << (INTERFACE - 83)) | (1L << (RULE_ID - 83)))) != 0)) {
					{
					{
					setState(161); psBlock();
					}
					}
					setState(166);
					_errHandler.sync(this);
	...
	public final PsImportsContext psImports() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(206); psQualifiedNameImport();
			...
			case 2:
				...
				setState(210); psQualifiedNameImport();
	...
	public final PsBlockContext psBlock() throws RecognitionException {
		...
		try {
			...
			case RULE_ID:
				...
				case 1:
					{
					setState(219); psDeclaration();
					}
					break;

				case 2:
					{
					setState(220); psInstantiation();
					}
					break;

				case 3:
					{
					setState(221); psStatement();
					}
					break;
				}
				}
	...
	public final PsProcessContext psProcess() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(234); ((PsProcessContext)_localctx).isProcess = match(17);
	...
	public final PsInstantiationContext psInstantiation() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(244); psInterfaceInstantiation();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(245); psDirectGeneration();
				}
				break;
			}
		}
	...
	public final PsInterfaceInstantiationContext psInterfaceInstantiation() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(248); psQualifiedName();
				setState(249); psVariable();
				setState(251);
				_la = _input.LA(1);
				if (_la==36) {
					{
					setState(250); psArray();
					}
				}
				...
				if (_la==6) {
					{
					setState(253); psPassedArguments();
					}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(258); psQualifiedName();
				setState(259); psVariable();
				setState(261);
				_la = _input.LA(1);
				if (_la==36) {
					{
					setState(260); psArray();
					}
				}
				...
				if (_la==6) {
					{
					setState(263); psPassedArguments();
					}
				}
	...
	public final PsDirectGenerationContext psDirectGeneration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==5) {
					{
					setState(270); ((PsDirectGenerationContext)_localctx).isInclude = match(5);
					}
				}

				setState(273); psInterface();
				setState(274); psVariable();
				setState(275); match(ASSGN);
				setState(276); match(15);
				setState(277); match(RULE_ID);
				setState(279);
				_la = _input.LA(1);
				if (_la==6) {
					{
					setState(278); psPassedArguments();
					}
				}
				...
				if (_la==RULE_GENERATOR_CONTENT) {
					{
					setState(281); match(RULE_GENERATOR_CONTENT);
					}
				}

				setState(284); match(20);
				}
				break;
			...
			case 2:
				...
				if (_la==5) {
					{
					setState(286); ((PsDirectGenerationContext)_localctx).isInclude = match(5);
					}
				}

				setState(289); psInterface();
				setState(290); psVariable();
				setState(291); match(ASSGN);
				setState(292); match(15);
				setState(293); match(RULE_ID);
				setState(295);
				_la = _input.LA(1);
				if (_la==6) {
					{
					setState(294); psPassedArguments();
					}
				}
				...
				if (_la==RULE_GENERATOR_CONTENT) {
					{
					setState(297); match(RULE_GENERATOR_CONTENT);
					}
				}
	...
	public final PsArgumentContext psArgument() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(317); match(RULE_ID);
			setState(318); match(ASSGN);
			setState(319); psExpression(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsCastContext psCast() throws RecognitionException {
		...
		try {
			...
			setState(322); psPrimitiveType();
			setState(324);
			_la = _input.LA(1);
			if (_la==LESS) {
				{
				setState(323); psWidth();
				}
			}
	...
	private PsExpressionContext psExpression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case LOGIC_NEG:
					{
					setState(330); ((PsManipContext)_localctx).type = match(LOGIC_NEG);
					}
					break;
				case BIT_NEG:
					{
					setState(331); ((PsManipContext)_localctx).type = match(BIT_NEG);
					}
					break;
				case ARITH_NEG:
					{
					setState(332); ((PsManipContext)_localctx).type = match(ARITH_NEG);
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				setState(335); psExpression(16);
				}
				break;
			...
			case 3:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(337); psArrayInitSubParens();
				}
				break;
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 7:
						...
						setState(363); match(XOR);
						setState(364); psExpression(9);
						}
						break;
					...
					case 8:
						...
						setState(366); match(OR);
						setState(367); psExpression(9);
						}
						break;
					...
					case 10:
						...
						setState(372); match(LOGI_AND);
						setState(373); psExpression(7);
						}
						break;
					...
					case 11:
						...
						setState(375); match(LOGI_OR);
						setState(376); psExpression(6);
						}
						break;
					...
					case 12:
						...
						setState(379); psExpression(0);
						setState(380); match(35);
						setState(381); psExpression(5);
						}
						break;
					}
					} 
	...
	public final PsValueContext psValue() throws RecognitionException {
		...
		try {
			...
			case RULE_PS_LITERAL_TERMINAL:
				enterOuterAlt(_localctx, 1);
				{
				setState(388); match(RULE_PS_LITERAL_TERMINAL);
				}
				break;
			case 25:
			case 34:
			case RULE_ID:
				enterOuterAlt(_localctx, 2);
				{
				setState(389); psVariableRef();
				}
				break;
			case RULE_STRING:
				enterOuterAlt(_localctx, 3);
				{
				setState(390); match(RULE_STRING);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PsAccessRangeContext psAccessRange() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(404); ((PsAccessRangeContext)_localctx).from = psExpression(0);
			setState(411);
			switch (_input.LA(1)) {
			case 35:
				{
				...
				setState(406); ((PsAccessRangeContext)_localctx).to = psExpression(0);
				}
				}
				break;
			case 41:
				...
				setState(408); ((PsAccessRangeContext)_localctx).inc = psExpression(0);
				}
				}
				break;
			case 42:
				...
				setState(410); ((PsAccessRangeContext)_localctx).dec = psExpression(0);
				}
				}
				break;
			case 8:
	...
	public final PsVariableRefContext psVariableRef() throws RecognitionException {
		...
		try {
			...
			case 34:
				enterOuterAlt(_localctx, 2);
				{
				setState(421); ((PsVariableRefContext)_localctx).isClk = match(34);
				}
				break;
			case 25:
				enterOuterAlt(_localctx, 3);
				{
				setState(422); ((PsVariableRefContext)_localctx).isRst = match(25);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PsStatementContext psStatement() throws RecognitionException {
		...
		try {
			...
			case 27:
				enterOuterAlt(_localctx, 1);
				{
				setState(437); psCompoundStatement();
				}
				break;
			case 17:
				enterOuterAlt(_localctx, 2);
				{
				setState(438); psProcess();
				}
				break;
			case 25:
			case 34:
			case RULE_ID:
				enterOuterAlt(_localctx, 3);
				{
				setState(439); psAssignmentOrFunc();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PsFunctionDeclarationContext psFunctionDeclaration() throws RecognitionException {
		...
		try {
			...
			case 16:
				enterOuterAlt(_localctx, 1);
				{
				setState(442); psNativeFunction();
				}
				break;
			case 19:
				enterOuterAlt(_localctx, 2);
				{
				setState(443); psInlineFunction();
				}
				break;
			case 33:
				enterOuterAlt(_localctx, 3);
				{
				setState(444); psSubstituteFunction();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PsInlineFunctionContext psInlineFunction() throws RecognitionException {
		...
		try {
			...
			setState(448); match(FUNCTION);
			setState(449); psFuncRecturnType();
			setState(450); psFunction();
			setState(451); psFuncParam();
			setState(452); match(31);
			setState(453); match(6);
			setState(454); psExpression(0);
			setState(455); match(40);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsSubstituteFunctionContext psSubstituteFunction() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(457); match(33);
			setState(458); match(FUNCTION);
			setState(460);
			_la = _input.LA(1);
			if (((((_la - 78)) & ~0x3f) == 0 && ((1L << (_la - 78)) & ((1L << (ANY_INT - 78)) | (1L << (ANY_UINT - 78)) | (1L << (ANY_BIT - 78)) | (1L << (ANY_IF - 78)) | (1L << (ANY_ENUM - 78)) | (1L << (BIT - 78)) | (1L << (INT - 78)) | (1L << (UINT - 78)) | (1L << (STRING - 78)) | (1L << (BOOL - 78)) | (1L << (ENUM - 78)) | (1L << (INTERFACE - 78)) | (1L << (FUNCTION - 78)))) != 0)) {
				{
				setState(459); psFuncRecturnType();
				}
			}

			setState(462); psFunction();
			setState(463); psFuncParam();
	...
	public final PsNativeFunctionContext psNativeFunction() throws RecognitionException {
		...
		try {
			...
			if (_la==13) {
				{
				setState(473); ((PsNativeFunctionContext)_localctx).isSim = match(13);
				}
			}

			setState(476); match(16);
			setState(477); match(FUNCTION);
			setState(479);
			_la = _input.LA(1);
			if (((((_la - 78)) & ~0x3f) == 0 && ((1L << (_la - 78)) & ((1L << (ANY_INT - 78)) | (1L << (ANY_UINT - 78)) | (1L << (ANY_BIT - 78)) | (1L << (ANY_IF - 78)) | (1L << (ANY_ENUM - 78)) | (1L << (BIT - 78)) | (1L << (INT - 78)) | (1L << (UINT - 78)) | (1L << (STRING - 78)) | (1L << (BOOL - 78)) | (1L << (ENUM - 78)) | (1L << (INTERFACE - 78)) | (1L << (FUNCTION - 78)))) != 0)) {
				{
				setState(478); psFuncRecturnType();
				}
			}

			setState(481); psFunction();
			setState(482); psFuncParam();
			setState(483); match(20);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsFuncRecturnTypeContext psFuncRecturnType() throws RecognitionException {
		...
		try {
			...
			while (_la==36) {
				{
				{
				setState(486); ((PsFuncRecturnTypeContext)_localctx).psFuncOptArray = psFuncOptArray();
	...
	public final PsFuncParamContext psFuncParam() throws RecognitionException {
		...
		try {
			...
			setState(501);
			_la = _input.LA(1);
			if (((((_la - 49)) & ~0x3f) == 0 && ((1L << (_la - 49)) & ((1L << (MUL - 49)) | (1L << (PLUS - 49)) | (1L << (ARITH_NEG - 49)) | (1L << (ANY_INT - 49)) | (1L << (ANY_UINT - 49)) | (1L << (ANY_BIT - 49)) | (1L << (ANY_IF - 49)) | (1L << (ANY_ENUM - 49)) | (1L << (BIT - 49)) | (1L << (INT - 49)) | (1L << (UINT - 49)) | (1L << (STRING - 49)) | (1L << (BOOL - 49)) | (1L << (ENUM - 49)) | (1L << (INTERFACE - 49)) | (1L << (FUNCTION - 49)))) != 0)) {
				{
				setState(493); psFuncSpec();
				setState(498);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==8) {
					{
					{
					setState(494); match(8);
					setState(495); psFuncSpec();
					}
					}
					setState(500);
					_errHandler.sync(this);
	...
	public final PsFuncSpecContext psFuncSpec() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(505); psFuncParamWithRW();
			setState(506); match(RULE_ID);
			setState(510);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==36) {
				{
				{
				setState(507); ((PsFuncSpecContext)_localctx).psFuncOptArray = psFuncOptArray();
	...
	public final PsFuncParamWithRWContext psFuncParamWithRW() throws RecognitionException {
		...
		try {
			...
			if (((((_la - 49)) & ~0x3f) == 0 && ((1L << (_la - 49)) & ((1L << (MUL - 49)) | (1L << (PLUS - 49)) | (1L << (ARITH_NEG - 49)))) != 0)) {
				{
				setState(513); psFuncParamRWType();
				}
			}

			setState(516); psFuncParamType();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsFuncOptArrayContext psFuncOptArray() throws RecognitionException {
		...
		try {
			...
			setState(520);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 3) | (1L << 6) | (1L << 25) | (1L << 34))) != 0) || ((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (ARITH_NEG - 75)) | (1L << (BIT_NEG - 75)) | (1L << (LOGIC_NEG - 75)) | (1L << (RULE_PS_LITERAL_TERMINAL - 75)) | (1L << (RULE_ID - 75)) | (1L << (RULE_STRING - 75)))) != 0)) {
				{
				setState(519); psExpression(0);
				}
			}
	...
	public final PsFuncParamTypeContext psFuncParamType() throws RecognitionException {
		...
		try {
			...
			case ANY_INT:
				enterOuterAlt(_localctx, 1);
				{
				setState(526); match(ANY_INT);
				}
				break;
			case ANY_UINT:
				enterOuterAlt(_localctx, 2);
				{
				setState(527); match(ANY_UINT);
				}
				break;
			case ANY_BIT:
				enterOuterAlt(_localctx, 3);
				{
				setState(528); match(ANY_BIT);
				}
				break;
			case ANY_IF:
				enterOuterAlt(_localctx, 4);
				{
				setState(529); match(ANY_IF);
				}
				break;
			case ANY_ENUM:
				enterOuterAlt(_localctx, 5);
				{
				setState(530); match(ANY_ENUM);
				}
				break;
			case BOOL:
			...
			case BIT:
				...
				{
				{
				setState(533); match(BIT);
				setState(535);
				_la = _input.LA(1);
				if (_la==LESS) {
					{
					setState(534); psWidth();
					}
				}
			...
			case UINT:
				...
				{
				{
				setState(537); match(UINT);
				setState(539);
				_la = _input.LA(1);
				if (_la==LESS) {
					{
					setState(538); psWidth();
					}
				}
			...
			case INTERFACE:
				...
				{
				{
				setState(545); match(INTERFACE);
				setState(546); match(LESS);
				setState(547); psQualifiedName();
				setState(548); match(GREATER);
				}
				}
				break;
			case ENUM:
				...
				{
				{
				setState(550); match(ENUM);
				setState(551); match(LESS);
				setState(552); psQualifiedName();
				setState(553); match(GREATER);
				}
				}
				break;
			case FUNCTION:
				...
				{
				{
				setState(555); match(FUNCTION);
				setState(556); match(LESS);
				setState(565);
				_la = _input.LA(1);
				if (((((_la - 49)) & ~0x3f) == 0 && ((1L << (_la - 49)) & ((1L << (MUL - 49)) | (1L << (PLUS - 49)) | (1L << (ARITH_NEG - 49)) | (1L << (ANY_INT - 49)) | (1L << (ANY_UINT - 49)) | (1L << (ANY_BIT - 49)) | (1L << (ANY_IF - 49)) | (1L << (ANY_ENUM - 49)) | (1L << (BIT - 49)) | (1L << (INT - 49)) | (1L << (UINT - 49)) | (1L << (STRING - 49)) | (1L << (BOOL - 49)) | (1L << (ENUM - 49)) | (1L << (INTERFACE - 49)) | (1L << (FUNCTION - 49)))) != 0)) {
					{
					setState(557); psFuncParamWithRW();
					setState(562);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==8) {
						...
						setState(559); psFuncParamWithRW();
						}
						}
						setState(564);
						_errHandler.sync(this);
				...
				if (_la==37) {
					...
					setState(568); ((PsFuncParamTypeContext)_localctx).returnType = psFuncParamType();
					}
				}

				setState(571); match(GREATER);
				}
				}
				break;
			default:
	...
	public final PsFuncArgsContext psFuncArgs() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(576); match(6);
			setState(585);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 3) | (1L << 6) | (1L << 25) | (1L << 34))) != 0) || ((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (ARITH_NEG - 75)) | (1L << (BIT_NEG - 75)) | (1L << (LOGIC_NEG - 75)) | (1L << (RULE_PS_LITERAL_TERMINAL - 75)) | (1L << (RULE_ID - 75)) | (1L << (RULE_STRING - 75)))) != 0)) {
				{
				setState(577); psExpression(0);
				setState(582);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==8) {
	...
	public final PsAssignmentOrFuncContext psAssignmentOrFunc() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(589); psVariableRef();
				setState(593);
				_la = _input.LA(1);
				if (((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & ((1L << (ASSGN - 63)) | (1L << (ADD_ASSGN - 63)) | (1L << (SUB_ASSGN - 63)) | (1L << (MUL_ASSGN - 63)) | (1L << (DIV_ASSGN - 63)) | (1L << (MOD_ASSGN - 63)) | (1L << (AND_ASSGN - 63)) | (1L << (XOR_ASSGN - 63)) | (1L << (OR_ASSGN - 63)) | (1L << (SLL_ASSGN - 63)) | (1L << (SRL_ASSGN - 63)) | (1L << (SRA_ASSGN - 63)))) != 0)) {
					{
					setState(590); psAssignmentOp();
					setState(591); psExpression(0);
					}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(597); psVariableRef();
				setState(601);
				_la = _input.LA(1);
				if (((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & ((1L << (ASSGN - 63)) | (1L << (ADD_ASSGN - 63)) | (1L << (SUB_ASSGN - 63)) | (1L << (MUL_ASSGN - 63)) | (1L << (DIV_ASSGN - 63)) | (1L << (MOD_ASSGN - 63)) | (1L << (AND_ASSGN - 63)) | (1L << (XOR_ASSGN - 63)) | (1L << (OR_ASSGN - 63)) | (1L << (SLL_ASSGN - 63)) | (1L << (SRL_ASSGN - 63)) | (1L << (SRA_ASSGN - 63)))) != 0)) {
					{
					setState(598); psAssignmentOp();
					setState(599); psExpression(0);
					}
				}
	...
	public final PsCompoundStatementContext psCompoundStatement() throws RecognitionException {
		...
		try {
			...
			case 23:
				enterOuterAlt(_localctx, 1);
				{
				setState(609); psIfStatement();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 2);
				{
				setState(610); psForStatement();
				}
				break;
			case 27:
				enterOuterAlt(_localctx, 3);
				{
				setState(611); psSwitchStatement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PsIfStatementContext psIfStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(614); match(23);
				setState(615); match(6);
				setState(616); psExpression(0);
				setState(617); match(40);
				setState(618); ((PsIfStatementContext)_localctx).ifBlk = psSimpleBlock();
				setState(621);
				switch ( getInterpreter().adaptivePredict(_input,72,_ctx) ) {
				case 1:
					{
					setState(619); match(39);
					setState(620); ((PsIfStatementContext)_localctx).elseBlk = psSimpleBlock();
					}
					break;
				}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(623); match(23);
				setState(624); psExpression(0);
				setState(625); ((PsIfStatementContext)_localctx).ifBlk = psSimpleBlock();
				setState(628);
				switch ( getInterpreter().adaptivePredict(_input,73,_ctx) ) {
				case 1:
					{
					setState(626); match(39);
					setState(627); ((PsIfStatementContext)_localctx).elseBlk = psSimpleBlock();
					}
					break;
				}
	...
	public final PsForStatementContext psForStatement() throws RecognitionException {
		...
		try {
			...
			setState(647); psVariable();
			setState(648); match(ASSGN);
			setState(649); psBitAccess();
			setState(650); match(40);
			setState(651); psSimpleBlock();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsSwitchStatementContext psSwitchStatement() throws RecognitionException {
		...
		try {
			...
			setState(654); match(6);
			setState(655); psVariableRef();
			setState(656); match(40);
			setState(657); match(3);
			setState(661);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==1 || _la==30) {
	...
	public final PsCaseStatementsContext psCaseStatements() throws RecognitionException {
		...
		try {
			...
			case 30:
				{
				setState(666); match(30);
				setState(667); psValue();
				}
				break;
			case 1:
				{
				setState(668); match(1);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PsDeclarationContext psDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(684); psDeclarationType();
			setState(686);
			_la = _input.LA(1);
			if (_la==20) {
				{
				setState(685); match(20);
				}
			}
	...
	public final PsDeclarationTypeContext psDeclarationType() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(688); psVariableDeclaration();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(689); psTypeDeclaration();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(690); psFunctionDeclaration();
				}
				break;
			}
		}
	...
	public final PsTypeDeclarationContext psTypeDeclaration() throws RecognitionException {
		...
		try {
			...
			case INTERFACE:
				enterOuterAlt(_localctx, 1);
				{
				setState(693); psInterfaceDeclaration();
				}
				break;
			case ENUM:
				enterOuterAlt(_localctx, 2);
				{
				setState(694); psEnumDeclaration();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PsEnumDeclarationContext psEnumDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==ASSGN) {
				{
				setState(699); ((PsEnumDeclarationContext)_localctx).hasAss = match(ASSGN);
				}
			}

			setState(702); match(3);
			setState(703); psVariable();
			setState(708);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==8) {
				{
				{
				setState(704); match(8);
				setState(705); psVariable();
				}
				}
				setState(710);
				_errHandler.sync(this);
		...
		try {
			...
			case 1:
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 9) | (1L << 26) | (1L << 29) | (1L << 32) | (1L << 38))) != 0)) {
					{
					setState(715); psDirection();
					}
				}

				setState(718); psPrimitive();
				setState(719); psDeclAssignment();
				setState(724);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==8) {
					{
					{
					setState(720); match(8);
					setState(721); psDeclAssignment();
					}
					}
					setState(726);
					_errHandler.sync(this);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(729); psDirection();
				setState(730); psDeclAssignment();
				setState(735);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==8) {
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(741); psPrimitive();
				setState(742); psDirection();
				setState(743); psDeclAssignment();
				setState(748);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==8) {
					{
					{
					setState(744); match(8);
					setState(745); psDeclAssignment();
					}
					}
					setState(750);
					_errHandler.sync(this);
			...
			case 4:
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 9) | (1L << 26) | (1L << 29) | (1L << 32) | (1L << 38))) != 0)) {
					{
					setState(754); psDirection();
					}
				}

				setState(757); psPrimitive();
				setState(758); psDeclAssignment();
				setState(763);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==8) {
	...
	public final PsDeclAssignmentContext psDeclAssignment() throws RecognitionException {
		...
		try {
			...
			setState(777); psVariable();
			setState(779);
			_la = _input.LA(1);
			if (_la==36) {
				{
				setState(778); psArray();
				}
			}
			...
			if (_la==ASSGN) {
				{
				setState(781); match(ASSGN);
				setState(782); psArrayInit();
				}
			}
	...
	public final PsArrayInitContext psArrayInit() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(786); psArrayInitSubParens();
				}
				break;
			}
		}
	...
	public final PsArrayInitSubParensContext psArrayInitSubParens() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(789); match(3);
			setState(790); psArrayInitSub();
			setState(791); match(22);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsArrayInitSubContext psArrayInitSub() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(801); psArrayInitSubParens();
				}
				break;
			}
		}
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(804); match(36);
					setState(805); psExpression(0);
					setState(806); match(10);
					}
					}
					break;
				default:
	...
	public final PsAnnotationContext psAnnotation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(814); psAnnotationType();
			setState(818);
			_la = _input.LA(1);
			if (_la==6) {
				{
				setState(815); match(6);
				setState(816); match(RULE_STRING);
	...
	public final PsAnnotationTypeContext psAnnotationType() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(820); match(11);
			setState(821); match(RULE_ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsPrimitiveContext psPrimitive() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==14) {
					{
					setState(823); ((PsPrimitiveContext)_localctx).isRegister = match(14);
					setState(825);
					_la = _input.LA(1);
					if (_la==6) {
						{
						setState(824); psPassedArguments();
						}
					}
				...
				case BOOL:
					{
					setState(829); psPrimitiveType();
					setState(831);
					_la = _input.LA(1);
					if (_la==LESS) {
						{
						setState(830); psWidth();
						}
					}
				...
				case ENUM:
					...
					case ENUM:
						{
						setState(833); ((PsPrimitiveContext)_localctx).isEnum = match(ENUM);
						}
						break;
					case 18:
						{
						setState(834); ((PsPrimitiveContext)_localctx).isRecord = match(18);
						}
						break;
					default:
						throw new NoViableAltException(this);
					}
					setState(837); psQualifiedName();
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case 2:
				...
				case BOOL:
					{
					setState(840); psPrimitiveType();
					setState(842);
					_la = _input.LA(1);
					if (_la==LESS) {
						{
						setState(841); psWidth();
						}
					}
				...
				case ENUM:
					...
					case ENUM:
						{
						setState(844); ((PsPrimitiveContext)_localctx).isEnum = match(ENUM);
						}
						break;
					case 18:
						{
						setState(845); ((PsPrimitiveContext)_localctx).isRecord = match(18);
						}
						break;
					default:
						throw new NoViableAltException(this);
					}
					setState(848); psQualifiedName();
					}
					break;
				default:
					throw new NoViableAltException(this);
				...
				{
				setState(851); ((PsPrimitiveContext)_localctx).isRegister = match(14);
				setState(853);
				_la = _input.LA(1);
				if (_la==6) {
					{
					setState(852); psPassedArguments();
					}
				}
	...
	public final PsWidthContext psWidth() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(861); match(LESS);
				setState(862); psExpression(0);
	...
	public final PsInterfaceDeclarationContext psInterfaceDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(870); match(INTERFACE);
			setState(871); psInterface();
			setState(874);
			_la = _input.LA(1);
			if (_la==21) {
				{
				setState(872); match(21);
				setState(873); psInterfaceExtends();
				}
			}

			setState(876); psInterfaceDecl();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsInterfaceDeclContext psInterfaceDecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(888); match(3);
			setState(892);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 9) | (1L << 11) | (1L << 14) | (1L << 18) | (1L << 26) | (1L << 29) | (1L << 32) | (1L << 38))) != 0) || ((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & ((1L << (BIT - 83)) | (1L << (INT - 83)) | (1L << (UINT - 83)) | (1L << (STRING - 83)) | (1L << (BOOL - 83)) | (1L << (ENUM - 83)))) != 0)) {
				{
				{
				setState(889); psPortDeclaration();
				}
				}
				setState(894);
				_errHandler.sync(this);
	...
	public final PsPortDeclarationContext psPortDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(903); psVariableDeclaration();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PsQualifiedNameContext psQualifiedName() throws RecognitionException {
		...
		try {
			...
			while (_la==28) {
				{
				{
				setState(906); match(28);
				setState(907); match(RULE_ID);
				}
				}
				setState(912);
				_errHandler.sync(this);
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 13: return psExpression_sempred((PsExpressionContext)_localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"\3\61\3\61\3\61\3\61\3\61\3\61\7\61\u02e0\n\61\f\61\16\61\u02e3\13\61"+
		"\3\61\3\61\3\61\3\61\3\61\3\61\3\61\3\61\7\61\u02ed\n\61\f\61\16\61\u02f0"+
		"\13\61\3\61\3\61\3\61\3\61\5\61\u02f6\n\61\3\61\3\61\3\61\3\61\7\61\u02fc"+
		...
		"\66\3\66\3\66\3\66\6\66\u032b\n\66\r\66\16\66\u032c\3\67\3\67\38\38\3"+
		"8\38\58\u0335\n8\39\39\39\3:\3:\5:\u033c\n:\5:\u033e\n:\3:\3:\5:\u0342"+
		"\n:\3:\3:\5:\u0346\n:\3:\5:\u0349\n:\3:\3:\5:\u034d\n:\3:\3:\5:\u0351"+
		"\n:\3:\5:\u0354\n:\3:\3:\5:\u0358\n:\3:\3:\5:\u035c\n:\3;\3;\3<\3<\3<"+
		"\3<\3<\3<\3<\5<\u0367\n<\3=\3=\3=\3=\5=\u036d\n=\3=\3=\3>\3>\3?\3?\3?"+
		...
		"\13B\3B\2\3\34C\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\60\62"+
		"\64\668:<>@BDFHJLNPRTVXZ\\^`bdfhjlnprtvxz|~\u0080\u0082