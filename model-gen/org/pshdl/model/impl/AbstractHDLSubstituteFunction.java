...
public abstract class AbstractHDLSubstituteFunction extends HDLFunction {
	...
	public HDLSubstituteFunction copyFiltered(CopyFilter filter) {
		...
		return filter.postFilter((HDLSubstituteFunction) this,
				new HDLSubstituteFunction(id, null, filteredannotations, filteredname, filteredargs, filteredreturnType, filteredstmnts, false));
	}
