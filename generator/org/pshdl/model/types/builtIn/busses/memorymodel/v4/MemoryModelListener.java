...
public interface MemoryModelListener extends ParseTreeListener {
	 ...
	 *            the parse tree
	 */
	void enterConstant(@NotNull MemoryModelParser.ConstantContext ctx);
	 ...
	 *            the parse tree
	 */
	void exitConstant(@NotNull MemoryModelParser.ConstantContext ctx);
	 ...
	 *            the parse tree
	 */
	void enterFilling(@NotNull MemoryModelParser.FillingContext ctx);
	 ...
	 *            the parse tree
	 */
	void exitFilling(@NotNull MemoryModelParser.FillingContext ctx);
