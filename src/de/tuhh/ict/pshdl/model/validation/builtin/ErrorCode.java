...
public enum ErrorCode implements IErrorCode {
	...
	// Assignement
	ASSIGNMENT_TARGET_TOO_SMALL(ERROR), ASSIGNMENT_NOT_ENUM(ERROR), ASSIGNEMENT_NOT_SUPPORTED(ERROR), ASSIGNMENT_NOT_PRIMITIVE(ERROR), ASSIGNMENT_CLIPPING_WILL_OCCUR(WARNING);
