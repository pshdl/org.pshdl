...
public enum ErrorCode {
	...
	// Various
	COMBINED_ASSIGNMENT_NOT_ALLOWED(ERROR), UNSUPPORTED_TYPE_FOR_OP(ERROR), MULTI_PROCESS_WRITE(ERROR), NO_SUCH_FUNCTION(ERROR),
	// Generator
	GENERATOR_NOT_KNOWN(ERROR), GENERATOR_ERROR(ERROR), GENERATOR_WARNING(WARNING), GENERATOR_INFO(INFO);
