...
public enum ErrorCode implements IErrorCode {
	...
	COMBINED_ASSIGNMENT_NOT_ALLOWED(ERROR), UNSUPPORTED_TYPE_FOR_OP(ERROR), MULTI_PROCESS_WRITE(ERROR), NO_SUCH_FUNCTION(ERROR), IN_PORT_CANT_REGISTER(ERROR), CONCAT_TYPE_NOT_ALLOWED(
			ERROR),
	// Generator
	GENERATOR_NOT_KNOWN(ERROR), GENERATOR_ERROR(ERROR), GENERATOR_WARNING(WARNING), GENERATOR_INFO(INFO), INLINE_FUNCTION_NO_TYPE(ERROR),
	// Variable naming
	...
	ASSIGNMENT_TARGET_TOO_SMALL(ERROR), ASSIGNMENT_NOT_ENUM(ERROR), ASSIGNEMENT_NOT_SUPPORTED(ERROR), ASSIGNMENT_NOT_PRIMITIVE(ERROR), ASSIGNMENT_CLIPPING_WILL_OCCUR(WARNING), ARRAY_INDEX_NO_RANGE(
			...
			WARNING), RANGE_NOT_UP(ERROR), RANGE_NOT_DOWN(ERROR), CONSTANT_PORT_CANT_REGISTER(ERROR), GLOBAL_CANT_REGISTER(ERROR);
