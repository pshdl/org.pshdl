...
public enum ErrorCode implements IErrorCode {
	...
	VARIABLE_SAME_NAME(ERROR), VARIABLE_KEYWORD_NAME(ERROR), VARIABLE_SAME_NAME_DIFFERENT_CASE(ERROR), VARIABLE_SCOPE_SAME_NAME(ERROR), VARIABLE_SCOPE_SAME_NAME_DIFFERENT_CASE(
			ERROR),
	// Swtich
	SWITCH_MULTIPLE_DEFAULT(ERROR), SWITCH_NO_DEFAULT(ERROR), SWITCH_LABEL_NOT_CONSTANT(ERROR), SWITCH_LABEL_DUPLICATE(ERROR), SWITCH_CASE_NEEDS_WIDTH(ERROR), SWITCH_LABEL_WRONG_ENUM(
			ERROR),
	// Assignement
	ASSIGNMENT_TARGET_TOO_SMALL(ERROR), ASSIGNMENT_NOT_ENUM(ERROR), ASSIGNEMENT_NOT_SUPPORTED(ERROR), ASSIGNMENT_NOT_PRIMITIVE(ERROR), ASSIGNMENT_CLIPPING_WILL_OCCUR(WARNING), ARRAY_INDEX_NO_RANGE(
			ERROR), ARRAY_REFERENCE_TOO_FEW_DIMENSIONS_IN_EXPRESSION(ERROR), ASSIGNMENT_ENUM_NOT_WRITABLE(ERROR), ARRAY_WRITE_MULTI_DIMENSION(ERROR), ARRAY_DIMENSIONS_NOT_CONSTANT(
			ERROR), ARRAY_ASSIGNMENT_NOT_SAME_DIMENSIONS(ERROR), BIT_ACCESS_NOT_POSSIBLE(ERROR), BIT_ACCESS_NOT_POSSIBLE_ON_TYPE(ERROR), UNKNOWN_RANGE(WARNING), RANGE_OVERLAP(
			WARNING), RANGE_NOT_UP(ERROR), RANGE_NOT_DOWN(ERROR), CONSTANT_PORT_CANT_REGISTER(ERROR),
	// Globals
	GLOBAL_CANT_REGISTER(ERROR), FUNCTION_NOT_ENOUGH_ARGUMENTS(ERROR), GLOBAL_NOT_CONSTANT(ERROR);
