...
public enum ErrorCode implements IErrorCode {
	...
	// Constants
	CONSTANT_NEED_DEFAULTVALUE(ERROR), CONSTANT_DEFAULT_VALUE_NOT_CONSTANT(ERROR), FOR_LOOP_RANGE_NOT_CONSTANT(ERROR), CONSTANT_WIDTH_MISMATCH(WARNING), CONSTANT_PORT_CANT_REGISTER(
			ERROR),
	// Resolution
	...
	COMBINED_ASSIGNMENT_NOT_ALLOWED(ERROR), UNSUPPORTED_TYPE_FOR_OP(ERROR), MULTI_PROCESS_WRITE(ERROR), NO_SUCH_FUNCTION(ERROR), IN_PORT_CANT_REGISTER(ERROR), CONCAT_TYPE_NOT_ALLOWED(
			ERROR), BOOL_NEGATE_NUMERIC_NOT_SUPPORTED(ERROR), DIRECTION_NOT_ALLOWED_IN_SCOPE(ERROR),
	// Typing
	TYPE_INVALID_PRIMITIVE(ERROR), TYPE_NEGATIVE_WIDTH(ERROR), TYPE_POSSIBLY_NEGATIVE_WIDTH(WARNING), TYPE_ZERO_WIDTH(ERROR), TYPE_POSSIBLY_ZERO_WIDTH(WARNING),
	// Generator
	...
	ASSIGNMENT_NOT_ENUM(ERROR), ASSIGNMENT_NOT_SUPPORTED(ERROR), ASSIGNMENT_NOT_PRIMITIVE(ERROR), ASSIGNMENT_CLIPPING_WILL_OCCUR(WARNING), ARRAY_INDEX_NO_RANGE(ERROR), ARRAY_REFERENCE_TOO_FEW_DIMENSIONS_IN_EXPRESSION(
			ERROR), ASSIGNMENT_ENUM_NOT_WRITABLE(ERROR), ARRAY_WRITE_MULTI_DIMENSION(ERROR), ARRAY_DIMENSIONS_NOT_CONSTANT(ERROR), ARRAY_ASSIGNMENT_NOT_SAME_DIMENSIONS(ERROR),
	// Bit Access
	BIT_ACCESS_NOT_POSSIBLE(ERROR), BIT_ACCESS_NOT_POSSIBLE_ON_TYPE(ERROR), BIT_ACCESS_NEGATIVE(ERROR), BIT_ACCESS_POSSIBLY_NEGATIVE(ERROR), BIT_ACCESS_OUT_OF_BOUNDS(ERROR), BIT_ACCESS_POSSIBLY_OUT_OF_BOUNDS(
			ERROR),
	// Range errors
