...
import de.tuhh.ict.pshdl.generator.vhdl.VHDLStatementExtension;
...
public class VHDLPackageExtension {
  ...
  public List<LibraryUnit> toVHDL(final HDLUnit obj) {
    ...
    if (_hasPkgDeclarations) {
      ...
      Iterables.<PackageDeclarativeItem>addAll(_declarations, ((List) unit.externalTypes));
    ...
    Iterables.<EntityDeclarativeItem>addAll(_declarations_3, ((List) unit.internalTypes));
    List<BlockDeclarativeItem> _declarations_4 = a.getDeclarations();
    Iterables.<BlockDeclarativeItem>addAll(_declarations_4, ((List) unit.internals));
  ...
  private SequentialStatement createIfStatement(final HDLUnit hUnit, final ProcessStatement ps, final HDLRegisterConfig key, final LinkedList<SequentialStatement> value, final VHDLContext unit) {
    ...
    Expression<?> _vHDL = this.vee.toVHDL(_setVar);
    ...
    Expression<?> _vHDL_1 = this.vee.toVHDL(_setVar_1);
