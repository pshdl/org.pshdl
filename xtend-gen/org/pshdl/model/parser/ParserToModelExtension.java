...
public class ParserToModelExtension {
	...
	protected IHDLObject _toHDL(final PsArrayInitContext context) {
		...
		PsArrayInitSubParensContext _psArrayInitSubParens = context.psArrayInitSubParens();
		return this.toHDL(_psArrayInitSubParens);
	}

	protected IHDLObject _toHDL(final PsArrayInitExpContext context) {
		PsArrayInitSubParensContext _psArrayInitSubParens = context.psArrayInitSubParens();
		return this.toHDL(_psArrayInitSubParens);
	}
	...
	protected IHDLObject _toHDL(final PsArrayInitSubParensContext context) {
		PsArrayInitSubContext _psArrayInitSub = context.psArrayInitSub();
	...
	protected HDLSubstituteFunction _toHDL(final PsSubstituteFunctionContext context) {
		...
		List<PsFuncSpecContext> _psFuncSpec = _psFuncParam.psFuncSpec();
		final Function1<PsFuncSpecContext, HDLFunctionParameter> _function_1 = new Function1<PsFuncSpecContext, HDLFunctionParameter>() {
			@Override
			public HDLFunctionParameter apply(final PsFuncSpecContext it) {
				IHDLObject _hDL = ParserToModelExtension.this.toHDL(it);
				return ((HDLFunctionParameter) _hDL);
			}
		};
		List<HDLFunctionParameter> _map_1 = ListExtensions.<PsFuncSpecContext, HDLFunctionParameter> map(_psFuncSpec, _function_1);
		HDLSubstituteFunction _setArgs = func.setArgs(_map_1);
		func = _setArgs;
		PsFuncRecturnTypeContext _psFuncRecturnType = context.psFuncRecturnType();
		boolean _tripleNotEquals = (_psFuncRecturnType != null);
		if (_tripleNotEquals) {
			PsFuncRecturnTypeContext _psFuncRecturnType_1 = context.psFuncRecturnType();
	...
	protected HDLNativeFunction _toHDL(final PsNativeFunctionContext context) {
		...
		PsFuncParamContext _psFuncParam = context.psFuncParam();
		List<PsFuncSpecContext> _psFuncSpec = _psFuncParam.psFuncSpec();
		final Function1<PsFuncSpecContext, HDLFunctionParameter> _function = new Function1<PsFuncSpecContext, HDLFunctionParameter>() {
			@Override
			public HDLFunctionParameter apply(final PsFuncSpecContext it) {
				IHDLObject _hDL = ParserToModelExtension.this.toHDL(it);
				return ((HDLFunctionParameter) _hDL);
		...
		List<HDLFunctionParameter> _map = ListExtensions.<PsFuncSpecContext, HDLFunctionParameter> map(_psFuncSpec, _function);
	...
	protected HDLFunctionParameter _toHDL(final PsFuncRecturnTypeContext context) {
	...
	protected HDLFunctionParameter _toHDL(final PsFuncParamTypeContext context) {
		...
		if (_notEquals) {
			...
			HDLFunctionParameter _setContainer = res.setContainer((_hDL_1));
			res = _setContainer;
		}
		return res;
	}
	...
	public IHDLObject toHDL(final Object context) {
		if (context instanceof PsAddContext)
		...
		else if (context instanceof PsArrayInitExpContext)
			return _toHDL((PsArrayInitExpContext) context);
		...
		else if (context instanceof PsArrayInitSubParensContext)
			return _toHDL((PsArrayInitSubParensContext) context);
			...
			return _toHDL((PsFuncSpecContext) context);
