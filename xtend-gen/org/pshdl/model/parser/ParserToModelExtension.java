...
public class ParserToModelExtension {
  ...
  protected HDLArrayInit _toHDL(final PsArrayInitSubParensContext context) {
    HDLArrayInit _hDLArrayInit = new HDLArrayInit();
    ...
    final HDLArrayInit res = _hDLArrayInit.setExp(_map);
    return this.<HDLArrayInit>attachContext(res, context);
  }
