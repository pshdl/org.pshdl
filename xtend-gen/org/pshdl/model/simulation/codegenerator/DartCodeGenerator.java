...
public class DartCodeGenerator extends CommonCodeGenerator implements ITypeOuptutProvider {
	...
	protected CharSequence footer() {
		...
		_builder.newLine();
		{
			for (final VariableInformation vi : this.em.variables) {
				...
				_builder.append(" => ");
				final CharSequence _idName_5 = this.idName(vi.name, true, CommonCodeGenerator.NONE);
				_builder.append(_idName_5, "\t");
				_builder.append(";");
				_builder.newLineIfNotEmpty();
				_builder.append("\t");
				_builder.append("set ");
				final CharSequence _idName_6 = this.idName(vi.name, false, CommonCodeGenerator.NONE);
				_builder.append(_idName_6, "\t");
				_builder.append("(int newVal) => ");
				final CharSequence _idName_7 = this.idName(vi.name, true, CommonCodeGenerator.NONE);
	...
	public CharSequence getDescription() {
		...
		_builder.newLine();
		{
			...
			final Iterable<VariableInformation> _filter_1 = IterableExtensions
					.<VariableInformation> filter(((Iterable<VariableInformation>) Conversions.doWrapArray(this.em.variables)), _function_1);
		...
		_builder.newLine();
		{
			...
			final Iterable<VariableInformation> _filter_2 = IterableExtensions
					.<VariableInformation> filter(((Iterable<VariableInformation>) Conversions.doWrapArray(this.em.variables)), _function_2);
		...
		_builder.newLine();
		{
			...
			final Iterable<VariableInformation> _filter_3 = IterableExtensions
					.<VariableInformation> filter(((Iterable<VariableInformation>) Conversions.doWrapArray(this.em.variables)), _function_3);
	...
	public List<PSAbstractCompiler.CompileResult> invoke(final CommandLine cli, final ExecutableModel em, final Set<Problem> syntaxProblems) throws Exception {
		final DartCodeGeneratorParameter _dartCodeGeneratorParameter = new DartCodeGeneratorParameter(em);
