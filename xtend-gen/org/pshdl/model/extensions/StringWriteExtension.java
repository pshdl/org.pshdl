...
public class StringWriteExtension {
	...
	protected String _toString(final HDLBitOp bitOp, final SyntaxHighlighter highlight) {
		...
		boolean _or = false;
		final boolean _equals = Objects.equal(type, HDLBitOp.HDLBitOpType.LOGI_AND);
		if (_equals) {
			_or = true;
		} else {
			final boolean _equals_1 = Objects.equal(type, HDLBitOp.HDLBitOpType.LOGI_OR);
			_or = _equals_1;
		}
		if (_or) {
			final String _simpleSpace = highlight.simpleSpace();
	...
	protected String _toString(final HDLExport export, final SyntaxHighlighter highlight) {
		...
		final HDLExpression _exportRef = export.getExportRef();
		final String _string = this.toString(_exportRef, highlight);
	...
	protected String _toString(final HDLRegisterConfig reg, final SyntaxHighlighter highlight) {
		...
		if (_tripleNotEquals) {
			...
			final boolean _tripleNotEquals_1 = (_clockType != null);
			if (!_tripleNotEquals_1) {
				_and = false;
			} else {
				final HDLRegisterConfig.HDLRegClockType _clockType_1 = reg.getClockType();
				final HDLRegisterConfig.HDLRegClockType _clockType_2 = defaultReg.getClockType();
				final boolean _tripleNotEquals_2 = (_clockType_1 != _clockType_2);
			...
			if (_and) {
				...
				final StringBuilder _append_9 = _append_8.append(".");
				final HDLRegisterConfig.HDLRegClockType _clockType_3 = reg.getClockType();
				final String _string_3 = _clockType_3.toString();
		...
		final boolean _tripleNotEquals_3 = (_unresolvedSyncType != null);
		if (_tripleNotEquals_3) {
			...
			final boolean _tripleNotEquals_4 = (_syncType != null);
			if (!_tripleNotEquals_4) {
				_and_1 = false;
			} else {
				final HDLRegisterConfig.HDLRegSyncType _syncType_1 = reg.getSyncType();
				final HDLRegisterConfig.HDLRegSyncType _syncType_2 = defaultReg.getSyncType();
				final boolean _tripleNotEquals_5 = (_syncType_1 != _syncType_2);
			...
			if (_and_1) {
				...
				final HDLRegisterConfig.HDLRegSyncType _syncType_3 = reg.getSyncType();
				final String _string_5 = _syncType_3.toString();
		...
		final boolean _tripleNotEquals_6 = (_unresolvedResetType != null);
		if (_tripleNotEquals_6) {
			...
			final boolean _tripleNotEquals_7 = (_resetType != null);
			if (!_tripleNotEquals_7) {
				_and_2 = false;
			} else {
				final HDLRegisterConfig.HDLRegResetActiveType _resetType_1 = reg.getResetType();
				final HDLRegisterConfig.HDLRegResetActiveType _resetType_2 = defaultReg.getResetType();
				final boolean _tripleNotEquals_8 = (_resetType_1 != _resetType_2);
			...
			if (_and_2) {
				...
				final HDLRegisterConfig.HDLRegResetActiveType _resetType_3 = reg.getResetType();
				final String _string_7 = _resetType_3.toString();
